...
class Product {
    ...
    public function save() {
        try {
            ...
            if ($this->id === null) {
                $sql = "INSERT INTO products (brand, model, price, description, image_id) VALUES (:brand, :model, :price, :description, :image_id)";
            }
            else {
                $sql = "UPDATE products SET brand = :brand, model = :model, price = :price, description = :description, image_id = :image_id WHERE id = :id" ;
                $params[":id"] = $this->id;
            }
